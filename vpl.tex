...
\section{Satz von Greibach}
    ...
    \subsection{Satz (Greibach, 1974)}
        ...
        \subsubsection{Beispiel}
            ...
            $y_1y_2y_3$ \qq{kürzen}$\rightarrow \$a_1a_2^2a_1=\mu(y_1y_2y_3)$ ($\mu$ entfernt nebeneinander stehende zusammenpassende \qq{Klammern}; $y$ sind nur die interessanten Teile, der Rest steckt in x und z)\\
